                        ...
                        <div class="pro-details-quality">
                            ...
                            <div class="pro-details-cart btn-hover">
                                <a href="#" style="line-height: 0;padding:0;margin-left: 20px;">
                                    <input type="submit" name="addtocart" id="add-to-cart-form" onclick="addToCart()"  value="Thêm vào giỏ hàng" style="     background: #ffffff00;     border: none;     color: white;     height: 0px;     margin: 7px 0px 7px 0px;     padding: 21px 19px;     font-weight: bold; ">
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="single-review">
                                    ...
                                    <div class="review-content">
                                        ...
                                        <div class="review-bottom">
                                            <p>Mua sách từ shop thật sự là một trải nghiệm tuyệt vời - từ dịch vụ khách hàng nhiệt tình đến chất lượng sản phẩm vượt trội. Tôi hoàn toàn hài lòng!</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="single-review ">
                                    ...
                                    <div class="review-content">
                                        ...
                                        <div class="review-bottom">
                                            <p>Tôi ấn tượng với tốc độ giao hàng nhanh chóng của shop. sách đến tay tôi trong tình trạng hoàn hảo và nhanh chóng ngoài mong đợi. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
